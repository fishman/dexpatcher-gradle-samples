...
.method private getMinimumDistance(Ljava/util/List;FLcom/github/mikephil/charting/components/YAxis$AxisDependency;)F
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2116
    invoke-virtual {v1}, Lcom/github/mikephil/charting/highlight/Highlight;->getYPx()F
...
.method protected final getHighlightForX(FFF)Lcom/github/mikephil/charting/highlight/Highlight;
    .locals 7
    ...
    invoke-direct {p0, p1, p3, v0}, Lcom/github/mikephil/charting/highlight/ChartHighlighter;->getMinimumDistance(Ljava/util/List;FLcom/github/mikephil/charting/components/YAxis$AxisDependency;)F
    ...
    invoke-direct {p0, p1, p3, v2}, Lcom/github/mikephil/charting/highlight/ChartHighlighter;->getMinimumDistance(Ljava/util/List;FLcom/github/mikephil/charting/components/YAxis$AxisDependency;)F
    ...
    invoke-interface {v2}, Lcom/github/mikephil/charting/interfaces/dataprovider/BarLineScatterCandleBubbleDataProvider;->getMaxHighlightDistance()F
    ...
    .line 1214
    invoke-virtual {v4}, Lcom/github/mikephil/charting/highlight/Highlight;->getAxis()Lcom/github/mikephil/charting/components/YAxis$AxisDependency;
    ...
    .line 1216
    :cond_2
    invoke-virtual {v4}, Lcom/github/mikephil/charting/highlight/Highlight;->getXPx()F

    move-result v5

    invoke-virtual {v4}, Lcom/github/mikephil/charting/highlight/Highlight;->getYPx()F
...
.method protected getHighlightsAtXValue(FFF)Ljava/util/List;
    ...
    .line 135
    iget-object p0, p0, Lcom/github/mikephil/charting/highlight/ChartHighlighter;->mHighlightBuffer:Ljava/util/List;
...
.method protected final getValsForTouch(FF)Lcom/github/mikephil/charting/utils/MPPointD;
    .locals 1
    ...
    invoke-interface {p0, v0}, Lcom/github/mikephil/charting/interfaces/dataprovider/BarLineScatterCandleBubbleDataProvider;->getTransformer(Lcom/github/mikephil/charting/components/YAxis$AxisDependency;)Lcom/github/mikephil/charting/utils/Transformer;

    move-result-object p0

    invoke-virtual {p0, p1, p2}, Lcom/github/mikephil/charting/utils/Transformer;->getValuesByTouchPoint(FF)Lcom/github/mikephil/charting/utils/MPPointD;
