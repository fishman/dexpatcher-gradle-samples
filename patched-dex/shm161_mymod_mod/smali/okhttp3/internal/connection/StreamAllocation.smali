...
.method private findConnection(IIIIZ)Lokhttp3/internal/connection/RealConnection;
    ...
    .line 1290
    iget-boolean v4, v4, Lokhttp3/internal/connection/RealConnection;->noNewStreams:Z

    if-eqz v4, :cond_3

    .line 1291
    invoke-direct {v1, v7, v7, v5}, Lokhttp3/internal/connection/StreamAllocation;->deallocate(ZZZ)Ljava/net/Socket;
    ...
    .line 181
    :goto_1
    iget-boolean v9, v1, Lokhttp3/internal/connection/StreamAllocation;->reportedAcquired:Z
    ...
    .line 200
    invoke-static {}, Lokhttp3/EventListener;->connectionReleased$295518d7()V

    :cond_8
    if-eqz v3, :cond_9

    .line 203
    invoke-static {}, Lokhttp3/EventListener;->connectionAcquired$295518d7()V
    ...
    .line 218
    :try_start_1
    iget-boolean v8, v1, Lokhttp3/internal/connection/StreamAllocation;->canceled:Z
    ...
    .line 246
    invoke-virtual {v1, v9, v7}, Lokhttp3/internal/connection/StreamAllocation;->acquire(Lokhttp3/internal/connection/RealConnection;Z)V
    ...
    .line 263
    :try_start_2
    iput-boolean v5, v1, Lokhttp3/internal/connection/StreamAllocation;->reportedAcquired:Z
...
.method public final streamFailed(Ljava/io/IOException;)V
    ...
    iget-boolean p0, p0, Lokhttp3/internal/connection/StreamAllocation;->reportedAcquired:Z
...
.method public final streamFinished(ZLokhttp3/internal/http/HttpCodec;JLjava/io/IOException;)V
    ...
    .line 297
    invoke-static {}, Lokhttp3/EventListener;->responseBodyEnd$58ea2f5e()V
    ...
    .line 312
    :cond_2
    iget-boolean p0, p0, Lokhttp3/internal/connection/StreamAllocation;->released:Z
    ...
    .line 322
    invoke-static {}, Lokhttp3/EventListener;->callEnd$36f033da()V
