...
.method private newStream(ILjava/util/List;Z)Lokhttp3/internal/http2/Http2Stream;
    ...
    invoke-direct {p0, v0}, Lokhttp3/internal/http2/Http2Connection;->shutdown(Lokhttp3/internal/http2/ErrorCode;)V
    ...
    .line 241
    :cond_1
    iget v7, p0, Lokhttp3/internal/http2/Http2Connection;->nextStreamId:I
    ...
    iget-wide v0, v8, Lokhttp3/internal/http2/Http2Stream;->bytesLeftInWriteWindow:J
    ...
    .line 245
    :goto_1
    invoke-virtual {v8}, Lokhttp3/internal/http2/Http2Stream;->isOpen()Z
    ...
    invoke-virtual {v0, p1, v7, p2}, Lokhttp3/internal/http2/Http2Writer;->synStream$64c3d190(ZILjava/util/List;)V
...
.method private shutdown(Lokhttp3/internal/http2/ErrorCode;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method final close(Lokhttp3/internal/http2/ErrorCode;Lokhttp3/internal/http2/ErrorCode;)V
    ...
    .line 447
    :try_start_0
    invoke-direct {p0, p1}, Lokhttp3/internal/http2/Http2Connection;->shutdown(Lokhttp3/internal/http2/ErrorCode;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method final pushDataLater(ILokio/BufferedSource;IZ)V
    .locals 9
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
