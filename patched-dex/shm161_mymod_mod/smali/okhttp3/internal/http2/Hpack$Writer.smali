...
.method private writeByteString(Lokio/ByteString;)V
    .locals 3
    ...
    invoke-static {p1}, Lokhttp3/internal/http2/Huffman;->encodedLength(Lokio/ByteString;)I
    ...
    invoke-static {p1, v0}, Lokhttp3/internal/http2/Huffman;->encode(Lokio/ByteString;Lokio/BufferedSink;)V
    ...
    invoke-direct {p0, v0, v1, v2}, Lokhttp3/internal/http2/Hpack$Writer;->writeInt(III)V
...
.method final setHeaderTableSizeSetting(I)V
    ...
    .line 1581
    iget p1, p0, Lokhttp3/internal/http2/Hpack$Writer;->maxDynamicTableByteCount:I
    ...
    invoke-direct {p0, p1}, Lokhttp3/internal/http2/Hpack$Writer;->evictToRecoverBytes(I)I
...
.method final writeHeaders(Ljava/util/List;)V
    ...
    invoke-direct {p0, v0, v4, v3}, Lokhttp3/internal/http2/Hpack$Writer;->writeInt(III)V
    ...
    .line 509
    invoke-direct {p0, v6, v3, v4}, Lokhttp3/internal/http2/Hpack$Writer;->writeInt(III)V
    ...
    .line 513
    invoke-direct {p0, v4}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Lokio/ByteString;)V

    .line 514
    invoke-direct {p0, v5}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Lokio/ByteString;)V
    ...
    invoke-virtual {v4, v1, v7, v1, v8}, Lokio/ByteString;->rangeEquals(ILokio/ByteString;II)Z
    ...
    .line 519
    invoke-direct {p0, v9, v3, v1}, Lokhttp3/internal/http2/Hpack$Writer;->writeInt(III)V
    ...
    .line 523
    invoke-direct {p0, v9, v4, v6}, Lokhttp3/internal/http2/Hpack$Writer;->writeInt(III)V
