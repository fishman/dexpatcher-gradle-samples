...
.method public assertNotMainThread()V
    ...
    .line 200
    iget-boolean p0, p0, Landroid/arch/persistence/room/RoomDatabase;->mAllowMainThreadQueries:Z
...
.method public beginTransaction()V
    ...
    .line 253
    iget-object p0, p0, Landroid/arch/persistence/room/RoomDatabase;->mInvalidationTracker:Landroid/arch/persistence/room/InvalidationTracker;
...
.method public close()V
    ...
    .line 186
    iget-object p0, p0, Landroid/arch/persistence/room/RoomDatabase;->mCloseLock:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public compileStatement(Ljava/lang/String;)Landroid/arch/persistence/db/SupportSQLiteStatement;
    ...
    .line 244
    iget-object p0, p0, Landroid/arch/persistence/room/RoomDatabase;->mOpenHelper:Landroid/arch/persistence/db/SupportSQLiteOpenHelper;

    invoke-interface {p0}, Landroid/arch/persistence/db/SupportSQLiteOpenHelper;->getWritableDatabase()Landroid/arch/persistence/db/SupportSQLiteDatabase;

    move-result-object p0

    invoke-interface {p0, p1}, Landroid/arch/persistence/db/SupportSQLiteDatabase;->compileStatement(Ljava/lang/String;)Landroid/arch/persistence/db/SupportSQLiteStatement;
...
.method public endTransaction()V
    ...
    invoke-virtual {p0}, Landroid/arch/persistence/room/InvalidationTracker;->refreshVersionsAsync()V
...
.method public inTransaction()Z
    ...
    invoke-interface {p0}, Landroid/arch/persistence/db/SupportSQLiteDatabase;->inTransaction()Z
...
.method protected internalInitInvalidationTracker(Landroid/arch/persistence/db/SupportSQLiteDatabase;)V
    ...
    invoke-virtual {p0, p1}, Landroid/arch/persistence/room/InvalidationTracker;->internalInit(Landroid/arch/persistence/db/SupportSQLiteDatabase;)V
...
.method public isOpen()Z
    ...
    .line 173
    iget-object p0, p0, Landroid/arch/persistence/room/RoomDatabase;->mDatabase:Landroid/arch/persistence/db/SupportSQLiteDatabase;

    if-eqz p0, :cond_0

    .line 174
    invoke-interface {p0}, Landroid/arch/persistence/db/SupportSQLiteDatabase;->isOpen()Z
...
.method public query(Landroid/arch/persistence/db/SupportSQLiteQuery;)Landroid/database/Cursor;
    ...
    invoke-interface {p0, p1}, Landroid/arch/persistence/db/SupportSQLiteDatabase;->query(Landroid/arch/persistence/db/SupportSQLiteQuery;)Landroid/database/Cursor;
...
.method public query(Ljava/lang/String;[Ljava/lang/Object;)Landroid/database/Cursor;
    ...
    invoke-interface {p0, v0}, Landroid/arch/persistence/db/SupportSQLiteDatabase;->query(Landroid/arch/persistence/db/SupportSQLiteQuery;)Landroid/database/Cursor;
