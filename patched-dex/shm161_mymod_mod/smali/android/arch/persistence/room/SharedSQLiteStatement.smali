...
.method private createNewStatement()Landroid/arch/persistence/db/SupportSQLiteStatement;
    ...
    .line 65
    iget-object p0, p0, Landroid/arch/persistence/room/SharedSQLiteStatement;->mDatabase:Landroid/arch/persistence/room/RoomDatabase;

    invoke-virtual {p0, v0}, Landroid/arch/persistence/room/RoomDatabase;->compileStatement(Ljava/lang/String;)Landroid/arch/persistence/db/SupportSQLiteStatement;
...
.method private getStmt(Z)Landroid/arch/persistence/db/SupportSQLiteStatement;
    ...
    .line 74
    :cond_0
    iget-object p0, p0, Landroid/arch/persistence/room/SharedSQLiteStatement;->mStmt:Landroid/arch/persistence/db/SupportSQLiteStatement;
...
.method public release(Landroid/arch/persistence/db/SupportSQLiteStatement;)V
    ...
    .line 97
    iget-object p0, p0, Landroid/arch/persistence/room/SharedSQLiteStatement;->mLock:Ljava/util/concurrent/atomic/AtomicBoolean;
