...
.method public varargs constructor <init>(Landroid/arch/persistence/room/RoomDatabase;[Ljava/lang/String;)V
    ...
    .line 138
    iget-object p0, p0, Landroid/arch/persistence/room/InvalidationTracker;->mTableVersions:[J
...
.method private ensureInitialization()Z
    ...
    .line 289
    :cond_1
    iget-boolean p0, p0, Landroid/arch/persistence/room/InvalidationTracker;->mInitialized:Z
...
.method private startTrackingTable(Landroid/arch/persistence/db/SupportSQLiteDatabase;I)V
    ...
    .line 190
    iget-object p0, p0, Landroid/arch/persistence/room/InvalidationTracker;->mTableNames:[Ljava/lang/String;
    ...
    .line 195
    invoke-static {v0, p0, v5}, Landroid/arch/persistence/room/InvalidationTracker;->appendTriggerName(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v5, "` BEGIN INSERT OR REPLACE INTO room_table_modification_log"
...
.method private stopTrackingTable(Landroid/arch/persistence/db/SupportSQLiteDatabase;I)V
    ...
    .line 181
    sget-object v0, Landroid/arch/persistence/room/InvalidationTracker;->TRIGGERS:[Ljava/lang/String;
    ...
    .line 184
    invoke-static {p2, p0, v4}, Landroid/arch/persistence/room/InvalidationTracker;->appendTriggerName(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {p1, v4}, Landroid/arch/persistence/db/SupportSQLiteDatabase;->execSQL(Ljava/lang/String;)V
...
.method public refreshVersionsAsync()V
    ...
    iget-object p0, p0, Landroid/arch/persistence/room/InvalidationTracker;->mRefreshRunnable:Ljava/lang/Runnable;

    invoke-virtual {v0, p0}, Landroid/arch/core/executor/ArchTaskExecutor;->executeOnDiskIO(Ljava/lang/Runnable;)V
