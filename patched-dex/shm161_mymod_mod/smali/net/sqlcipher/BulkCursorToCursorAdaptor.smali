...
.method public final commitUpdates(Ljava/util/Map;)Z
    ...
    const-string p1, "commitUpdates not supported on this cursor, did you include the _id column?"
    ...
    const-string p1, "Unable to commit updates because the remote process is dead"
...
.method public final deleteRow()Z
    ...
    const-string v0, "Unable to delete row because the remote process is dead"
...
.method public final getColumnNames()[Ljava/lang/String;
    ...
    const-string v0, "Unable to fetch column names because the remote process is dead"
    ...
    :cond_0
    :goto_0
    iget-object p0, p0, Lnet/sqlcipher/BulkCursorToCursorAdaptor;->mColumns:[Ljava/lang/String;
...
.method public final getCount()I
    ...
    .line 98
    iget p0, p0, Lnet/sqlcipher/BulkCursorToCursorAdaptor;->mCount:I
...
.method public final getExtras()Landroid/os/Bundle;
    ...
    .line 267
    :try_start_0
    iget-object p0, p0, Lnet/sqlcipher/BulkCursorToCursorAdaptor;->mBulkCursor:Lnet/sqlcipher/IBulkCursor;
...
.method public final onMove(II)Z
    ...
    :cond_3
    :goto_1
    iget-object p0, p0, Lnet/sqlcipher/BulkCursorToCursorAdaptor;->mWindow:Lnet/sqlcipher/CursorWindow;
...
.method public final set(Lnet/sqlcipher/IBulkCursor;)V
    ...
    const-string p1, "Setup failed because the remote process is dead"
