...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 190
    iget-object p0, p0, Lnet/sqlcipher/database/SQLiteCursor$MainThreadNotificationHandler;->wrappedCursor:Ljava/lang/ref/WeakReference;

    invoke-virtual {p0}, Ljava/lang/ref/WeakReference;->get()Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lnet/sqlcipher/database/SQLiteCursor;

    if-eqz p0, :cond_0

    .line 192
    invoke-static {p0}, Lnet/sqlcipher/database/SQLiteCursor;->access$700(Lnet/sqlcipher/database/SQLiteCursor;)V
