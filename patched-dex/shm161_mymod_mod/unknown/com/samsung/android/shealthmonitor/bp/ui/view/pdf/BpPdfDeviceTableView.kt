...
class BpPdfDeviceTableView constructor(context: Context, includeDateOfUse : Boolean) : LinearLayout (context) {

    var root: View
    init {
        var res: Int = R.layout.shealth_monitor_bp_pdf_device_table_view
