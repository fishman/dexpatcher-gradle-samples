...
class PrerequisiteStep1(activity: SHealthMonitorBpCalibrateFirstPrerequisiteActivity) : LinearLayout(activity) {
    ...
    private fun initView(activity: SHealthMonitorBpCalibrateFirstPrerequisiteActivity) {
        ...
        inflater.inflate(R.layout.shealth_monitor_bp_calibrate_first_prerequisite_step1, this, true)
    ...
    companion object {
        private val TAG = LOG.prefix + "PrerequisiteStep1"
    }
}
