...
class SHealthMonitorTermsAndConditionActivity : BaseAppCompatActivity() {
    ...
    private fun initView() {
        val titlePrefix = "shealth_monitory_tnc_title_"
        val descPrefix = "shealth_monitory_tnc_desc_"
    ...
    private fun addTitleTextView(resId : Int) {
        return mContentView.addView(TextView(this).apply {
            ...
            setText(resId)
            setTextColor(resources.getColor(R.color.privacy_title_color, null))
            typeface = fontFace
            textSize = 17f
    ...
    companion object {
        private val TAG = LOG.prefix + "SHealthMonitorTermsAndConditionActivity"
    }
}
